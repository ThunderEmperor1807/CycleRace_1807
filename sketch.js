...
function preload(){
  ...
  pA1 = loadAnimation("mainPlayer1.png","mainPlayer2.png");
  pA2= loadAnimation("mainPlayer3.png");
  
  oP1Img = loadAnimation("opponent1.png","opponent2.png");
  oP2Img = loadAnimation("opponent3.png");
  
  oY1Img = loadAnimation("opponent4.png","opponent5.png");
  oY2Img = loadAnimation("opponent6.png");
  
  oR1Img = loadAnimation("opponent7.png","opponent8.png");
  oR2Img = loadAnimation("opponent9.png");
...
function pinkCyclists(){
        o1 =createSprite(1500,Math.round(random(50, 250)));
        o1.scale =0.06;
...
function yellowCyclists(){
        o2 =createSprite(1500,Math.round(random(50, 250)));
        o2.scale =0.06;
...
function redCyclists(){
        o3 =createSprite(1500,Math.round(random(50, 250)));
        o3.scale =0.06;
